...
import { ClusterTwoClient } from './contract/clients/ClusterTwoClient'
...
const App = () => {
  ...
  const contractClient = useMemo(() => {
    ...
    return new ClusterTwoClient(lcd, connectedWallet, contractAddress('clusterTwo', connectedWallet));
  }, [lcd, connectedWallet]);
